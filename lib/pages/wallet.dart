...
import 'package:wallet/pages/create_or_import.dart';
import 'package:web3dart/web3dart.dart';
import 'package:wallet/utils/get_balances.dart';
  ...
  Future<void> loadWalletData() async {
    ...
    if (privateKey != null) {
      ...
      EtherAmount latestBalance =
          EtherAmount.fromUnitAndValue(EtherUnit.wei, BigInt.parse(newBalance));
